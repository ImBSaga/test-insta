...
class _FeedScreenState extends State<FeedScreen> {
  ...
  final StoriesBloc _storiesBloc = StoriesBloc();
                          ...
                          child: Column(
                            children: <Widget>[
                              ListTile(
                                ...
                                subtitle: Text(snapshot.data[index].timeAgo),
                                trailing: IconButton(
                              ...
                              InkWell(
                                ...
                                onTap: () {
                                  _postBloc.postView.add(snapshot.data[index]);
                                },
                                child: Container(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          Container(
            width: double.infinity,
            height: 100.0,
            child: StreamBuilder<List<Stories>>(
                        ...
                        child: CircleAvatar(
                          child: ClipOval(
                            child: Image(
                              height: 60.0,
                              width: 60.0,
                              image: AssetImage(snapshot.data[index-1].authorImageUrl),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
